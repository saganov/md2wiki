...
``, `<pre>`, `<p>`, etc. -- must be separated from surrounding
...
in both `</code></a><code goes="" here=""><pre><a>` and `<code>` tags.
...
Will produce:
    ...
    </code></a><code><p><a>This is </a><a href="http://example.com/" title="Title">
...
into something like this:
    ...
    <a href="mailto:addre%20%20%20%20ss@example.co%20%20%20%20m">address@exa
    mple.com</a>
